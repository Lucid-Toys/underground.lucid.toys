...
function Clock(props) {
  ...
  console.log(timer.toLocaleDateString());
  var dayBeginning = new Date(timer.toLocaleDateString());
  console.log(timer, dayBeginning);
  var elapsed = Math.abs(timer - dayBeginning);
  console.log(elapsed);
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.c251ea155cef0465db00.hot-update.js.map