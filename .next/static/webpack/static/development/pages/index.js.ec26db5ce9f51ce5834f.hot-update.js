...
var ListItem = _emotion_styled__WEBPACK_IMPORTED_MODULE_2__["default"].li(_templateObject(), function (props) {
  ...
  return props.severity < 10 ? "1.5rem" : "1rem";
}, function (props) {
  return props.severity < 10 ? "space-between" : "center";
}, function (props) {
  return props.severity < 10 ? 3 : 1;
});
function TFLLine(_ref) {
  ...
  console.log(status);
  var severity = status[0].statusSeverity;
...
//# sourceMappingURL=index.js.ec26db5ce9f51ce5834f.hot-update.js.map